//simple regression example of scala sparkml linearRegression
...
// ("label","features")
// This will allow  to join multiple feature columns
...
// Note: Later we will see why should split
// the data first, but for now will fit to all the data.
